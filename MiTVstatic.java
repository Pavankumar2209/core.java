class MiTVstatic{
	...
	static String modelName	        = "Xiaomi TV 5X 50";
	static String colour		    = "Black";
	static String displayTechnology = "LED";
	static String refreshRate       = "60Hz";
	static String resolution	    = "4K";
	static String size	            = "43 inches";
	static int	 price              = 40999;
		
	public static void main(String a[]){
		
	//String brand	 	       = "MI";
	//String modelName	       = "Xiaomi TV 5X 50";
	//String colour		       = "Black";
	//String displayTechnology = "LED";
	//String refreshRate       = "60Hz";
	//String resolution	       = "4K";
	//String size	           = "43 inches";
	//int	 price             = 40999;
		
	
	System.out.println("Specification of MiTV ");
